...
GLuint TextureUtils::load_texture_cube(
    const int width, const int height,
    const std::filesystem::path filename_px, const std::filesystem::path filename_nx, const std::filesystem::path filename_py,
