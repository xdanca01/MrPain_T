...
void main()
{
	...
	float brightness = final_light.r * 0.299 + final_light.g * 0.587 + final_light.b * 0.114 - 1.0;
	if(brightness > 0.0){
		highlight_output = vec4(final_light * brightness, 1.0);
	}
	else{
		highlight_output = vec4(0.0, 0.0, 0.0, 1.0);
	}
}