...
// Constructors
// ----------------------------------------------------------------------------
Shader::Shader(GLenum shader_type, const std::filesystem::path& file_path)
    : shader_type(shader_type), file_path(file_path) {
...
Shader::Shader(const Shader& other)
    : Shader(other.shader_type, other.file_path) {}
