...
#include <fstream>
#include <iostream>
#include <cstring> // TODO use <cstring> instead of string as workaround for unix-based systems?
...
public:
    ...
    */
    ...
    static GLuint load_texture_cube(
        int width,
        int height,
        std::filesystem::path filename_px,
        std::filesystem::path filename_nx,
        std::filesystem::path filename_py,
        std::filesystem::path filename_ny,
        std::filesystem::path filename_pz,
