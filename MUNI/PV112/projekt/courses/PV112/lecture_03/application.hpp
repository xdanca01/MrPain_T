...
private:
    ...
    GLuint vbo_diamond_ver = 0;
    GLuint vbo_diamond_col = 0;
    GLuint vbo_square = 0;
    GLuint vbo_triangle = 0;
    GLuint vbo_diamond_indices = 0;
    GLuint vbo_diamond_pos_i = 0;
    GLuint vbo_diamond_col_i = 0;
    
    GLuint vao_diamond = 0;
    GLuint vao_diamond_index = 0;
    GLuint vao_square = 0;
