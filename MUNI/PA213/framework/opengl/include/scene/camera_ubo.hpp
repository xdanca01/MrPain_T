...
struct CameraData {
    ...
    CameraData()
        : CameraData(glm::mat4(1.0f), glm::mat4(1.0f), glm::vec3(1.0f)) {}
...
public:
    ...
    CameraUBO()
        : UBO<CameraData>(GL_DYNAMIC_STORAGE_BIT) {}
     ...
     */
    CameraUBO(std::vector<CameraData> data)
        : UBO<CameraData>(data, GL_DYNAMIC_STORAGE_BIT, GL_UNIFORM_BUFFER, cpu_only = false) {}
