...
function(visitlab_generate_lecture course lecture)
    ...
    # This is used mainly for PB009 lectures.
    if(ARG_SOLUTION AND EXISTS "${lecture_path}/solution/solution.cpp")
        set(executable_target "${course}_${lecture}_solution")
        add_executable(${executable_target} "application.hpp" "solution/solution.cpp" "main.cpp")
    elseif(NOT ARG_SOLUTION)
        set(executable_target "${course}_${lecture}")
        add_executable(${executable_target} "application.hpp" "application.cpp" "main.cpp")
    else()
...
function(visitlab_generate_lecture_tests course lecture)
    ...
    if(ARG_SOLUTION AND EXISTS "${lecture_path}/solution/solution.cpp")
        ...
        add_executable(${test_target_name} "../application.hpp" "../solution/solution.cpp" "test.cpp")
    elseif(NOT ARG_SOLUTION)
        set(test_target_name ${course}_${lecture}_test)
        add_executable(${test_target_name} "../application.hpp" "../application.cpp" "test.cpp")
    else()
        message(STATUS "Solution not available, terminating...")
        RETURN()
    endif()
