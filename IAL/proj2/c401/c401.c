...
**/
    ...
    {
        if(BSTSearch(RootPtr->LPtr, K, Content) == TRUE) return TRUE;
        return FALSE;
    }
    else if(RootPtr->Key < K)
    {
        if(BSTSearch(RootPtr->RPtr, K, Content) == TRUE) return TRUE;
        return FALSE;
    }
    return FALSE;
